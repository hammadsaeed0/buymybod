...
const Sidebar = ({ side, closeSidebar }) => {
  ...
  const [activeNav, setActiveNav] = useState("/addContent");
    ...
    >
      ...
      <ul className=" p-1 mt-4">
        ...
        >
          ...
          <Link href="/Creator-Dashboard/addContent" className="text-base capitalize font-semibold">
            Add Content
          </Link>
        </li>
        ...
        <li
          ...
          className={`px-4 cursor-pointer ${
            activeNav === "/contents" ? "bg-[#FCA311] text-black" : ""
          } transition-all py-1 my-1 text-black  dark:text-white flex items-center rounded-md hover:bg-[#FCA311]`}
        >
          <i className=" mr-2 inline-block text-lg">
            <FiSearch size={20} />
          </i>{" "}
          <Link href="/Creator-Dashboard/contents" className="text-base capitalize font-semibold">
            Contents
          </Link>
        </li>
        <li className="px-4 cursor-pointer transition-all py-1 my-1 text-black dark:text-white   flex items-center rounded-md hover:bg-[#FCA311]">
          ...
          <Link href="/Creator-Dashboard/messages" className="text-base capitalize font-semibold">
            Messages
          </Link>
        </li>
        <li className="px-4 cursor-pointer transition-all py-1 my-1 text-black  dark:text-white  flex items-center rounded-md hover:bg-[#FCA311]">
          ...
          <Link href="/Creator-Dashboard/notifications" className="text-base capitalize font-semibold">
            Notifications
          </Link>
        </li>
        <li className="px-4 cursor-pointer transition-all py-1 my-1 text-black dark:text-white  flex items-center rounded-md hover:bg-[#FCA311]">
        ...
        <li className="px-4 cursor-pointer transition-all py-1 my-1 text-black dark:text-white  flex items-center rounded-md hover:bg-[#FCA311]">
          ...
          <Link href="/Creator-Dashboard/Archive" className="text-base capitalize font-semibold">
            Archive
          </Link>
        </li>
        <li  onClick={() => {
          ...
          <Link href="/Creator-Dashboard/getPaid" className="text-base capitalize font-semibold">
            Get Paid
          </Link>
        </li>
      </ul>
      ...
      <ul className="mt-4 p-1">
        ...
        >
          ...
          <Link href="/Creator-Dashboard/settings" className="text-base capitalize font-semibold">
            Settings
          </Link>
        </li>
        <li className="px-4 cursor-pointer transition-all py-1 my-1 text-black dark:text-white  flex items-center rounded-md hover:bg-[#FCA311]">
